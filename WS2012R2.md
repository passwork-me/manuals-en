...
**1. Set hostname, install IIS 8, Bonjour Services.**
...
Download and install [Bonjour Print Services](http://support.apple.com/downloads/DL999/en_US/BonjourPSSetup.exe) for Windows.
